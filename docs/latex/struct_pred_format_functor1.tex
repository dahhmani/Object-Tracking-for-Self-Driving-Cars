...
{\footnotesize template$<$typename T1 $>$ }\\\hyperlink{classtesting_1_1_assertion_result}{testing\+::\+Assertion\+Result} {\bfseries operator()} (const char $\ast$e1, const T1 \&v1) const
